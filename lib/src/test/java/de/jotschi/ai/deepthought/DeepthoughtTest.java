...
//                "Ja, am Ende von Douglas Adams' 'Per Anhalter durch die Galaxis'-Reihe, in dem Buch 'Macht's gut und danke für den Fisch', wird die Erde von den Vogonen zerstört, um Platz für eine Umgehungsstraße zu machen."));
    ...
    public void noDeepThoughtTest() throws Exception  {
        Prompt prompt = new PromptImpl(QUERY + " Gib aus wieviel prozent der informationen aus dem context du für die beantwortung genutzt hast. Antworte JSON", Prompts.EVAL);
